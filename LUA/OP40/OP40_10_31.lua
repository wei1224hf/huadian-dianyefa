...
local Left_JinLiaoPan_count = 800  --左侧料盘数量自动判断
local Right_JinLiaoPan_count = 810 --右侧料盘数量自动判断
...
--左侧料盘数量计算
function fun_Left_JinLiaoPan_count()
  ...
  WaitDI("left_qian_roller_reached",1,5000,true)
  Sleep(500)
  SetDO("left_feeder_qian_roller_in",0)

  Rob_Point_1 = GetRobTarget("Xyzuvw",tool0,wobj0)
  Rob_Point_1.extax.eax_1 = K_L_1.extax.eax_1
  local ret = SearchL("left_qian_ShengJiang_reached",1,P10,Rob_Point_1,v100,tool0,wobj0,load0,0)
  if true==ret then
  elseif false==ret then
  end
  Sleep(500)
  Rob_eax1 = GetRobTarget("Xyzuvw",tool0,wobj0)
  if Rob_eax1.extax.eax_1 >=620 and Rob_eax1.extax.eax_1 <=655 then
  	SetAO("Left_in_tuopan_count",1)
  elseif Rob_eax1.extax.eax_1 >=515 and Rob_eax1.extax.eax_1 <=540 then
  	SetAO("Left_in_tuopan_count",2)
  elseif Rob_eax1.extax.eax_1 >=400 and Rob_eax1.extax.eax_1 <=425 then
  	SetAO("Left_in_tuopan_count",3)
  elseif Rob_eax1.extax.eax_1 >=285 and Rob_eax1.extax.eax_1 <=310 then
  	SetAO("Left_in_tuopan_count",4)
  elseif Rob_eax1.extax.eax_1 >=170 and Rob_eax1.extax.eax_1 <=200 then
  	SetAO("Left_in_tuopan_count",5)
  elseif Rob_eax1.extax.eax_1 >655 then
  	SetAO("Left_in_tuopan_count",0)
  end
  
  --左后料盘
  SetDO("left_feeder_hou_roller_in",1)
  WaitDI("left_hou_roller_reached",1,5000,true)
  Sleep(500)
  SetDO("left_feeder_hou_roller_in",0)
  
  Rob_Point_2 = GetRobTarget("Xyzuvw",tool0,wobj0)
  Rob_Point_2.extax.eax_2 = K_L_1.extax.eax_1
  local ret = SearchL("left_hou_ShengJiang_reached",1,P20,Rob_Point_2,v100,tool0,wobj0,load0,0)
  if true==ret then
  elseif false==ret then
  end
  Rob_eax2 = GetRobTarget("Xyzuvw",tool0,wobj0)
  if Rob_eax2.extax.eax_2 >=620 and Rob_eax2.extax.eax_2 <=655 then
  	SetAO("Left_out_tuopan_count",1)
  elseif Rob_eax2.extax.eax_2 >=515 and Rob_eax2.extax.eax_2 <=540 then
  	SetAO("Left_out_tuopan_count",2)
  elseif Rob_eax2.extax.eax_2 >=400 and Rob_eax2.extax.eax_2 <=425 then
  	SetAO("Left_out_tuopan_count",3)
  elseif Rob_eax2.extax.eax_2 >=285 and Rob_eax2.extax.eax_2 <=310 then
  	SetAO("Left_out_tuopan_count",4)
  elseif Rob_eax2.extax.eax_2 >=170 and Rob_eax2.extax.eax_2 <=200 then
  	SetAO("Left_out_tuopan_count",5)
  elseif Rob_eax2.extax.eax_2 >655 then
  	SetAO("Left_out_tuopan_count",0)
  end
end

--右侧料盘数量计算
function fun_Right_JinLiaoPan_count()
  local next = GetJointTarget("Xyzuvw")
  next.extax.eax_3 = 0
  next.extax.eax_4 = 0
  MoveAbsJ(next,v_op40,fine,tool0,wobj0,load0)
  ...
  WaitDI("right_qian_roller_reached",1,5000,true)
  Sleep(500)
  SetDO("right_feeder_qian_roller_in",0)

  Rob_Point_3 = GetRobTarget("Xyzuvw",tool0,wobj0)
  Rob_Point_3.extax.eax_3 = K_R_1.extax.eax_1
  local ret = SearchL("right_qian_ShengJiang_reached",1,P30,Rob_Point_3,v100,tool0,wobj0,load0,0)
  if true==ret then
  elseif false==ret then
  end
  Sleep(500)
  Rob_eax3 = GetRobTarget("Xyzuvw",tool0,wobj0)
  if Rob_eax3.extax.eax_3 >=620 and Rob_eax3.extax.eax_3 <=655 then
  	SetAO("Right_in_tuopan_count",1)
  elseif Rob_eax3.extax.eax_3 >=515 and Rob_eax3.extax.eax_3 <=540 then
  	SetAO("Right_in_tuopan_count",2)
  elseif Rob_eax3.extax.eax_3 >=400 and Rob_eax3.extax.eax_3 <=425 then
  	SetAO("Right_in_tuopan_count",3)
  elseif Rob_eax3.extax.eax_3 >=285 and Rob_eax3.extax.eax_3 <=310 then
  	SetAO("Right_in_tuopan_count",4)
  elseif Rob_eax3.extax.eax_3 >=170 and Rob_eax3.extax.eax_3 <=200 then
  	SetAO("Right_in_tuopan_count",5)
  elseif Rob_eax3.extax.eax_3 >655 then
  	SetAO("Right_in_tuopan_count",0)
  end
  
  --右后料盘
  SetDO("right_feeder_hou_roller_in",1)
  WaitDI("right_hou_roller_reached",1,5000,true)
  Sleep(500)
  SetDO("right_feeder_hou_roller_in",0)
  
  Rob_Point_4 = GetRobTarget("Xyzuvw",tool0,wobj0)
  Rob_Point_4.extax.eax_4 = K_R_1.extax.eax_1
  local ret = SearchL("right_hou_ShengJiang_reached",1,P40,Rob_Point_4,v100,tool0,wobj0,load0,0)
  if true==ret then
  elseif false==ret then
  end
  Rob_eax4 = GetRobTarget("Xyzuvw",tool0,wobj0)
  if Rob_eax4.extax.eax_4 >=620 and Rob_eax4.extax.eax_4 <=655 then
  	SetAO("Right_out_tuopan_count",1)
  elseif Rob_eax4.extax.eax_4 >=515 and Rob_eax4.extax.eax_4 <=540 then
  	SetAO("Right_out_tuopan_count",2)
  elseif Rob_eax4.extax.eax_4 >=400 and Rob_eax4.extax.eax_4 <=425 then
  	SetAO("Right_out_tuopan_count",3)
  elseif Rob_eax4.extax.eax_4 >=285 and Rob_eax4.extax.eax_4 <=310 then
  	SetAO("Right_out_tuopan_count",4)
  elseif Rob_eax4.extax.eax_4 >=170 and Rob_eax4.extax.eax_4 <=200 then
  	SetAO("Right_out_tuopan_count",5)
  elseif Rob_eax4.extax.eax_4 >655 then
  	SetAO("Right_out_tuopan_count",0)
  end
end
...
function fun_BUNK_LEFT_SHIFT()
    ...
    WaitDI("left_ZhuaPanZhao1_open",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("left_ZhuaPanZhao1_open") == 0 then
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",20)
	        Stop()
	    elseif GetDI("left_ZhuaPanZhao1_open") == 1 then
	    	break
	    end
    end

    WaitDI("left_ZhuaPanZhao2_open",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("left_ZhuaPanZhao2_open") == 0 then
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",20)
	        Stop()
	    elseif GetDI("left_ZhuaPanZhao2_open") == 1 then
	    	break
	    end
	end
    ...
    WaitDI("left_ZhuaPanZhao1_close",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("left_ZhuaPanZhao1_close") == 0 then
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",21)
	        Stop()
	    elseif GetDI("left_ZhuaPanZhao1_close") == 1 then
	    	break
	    end 
	end  

    WaitDI("left_ZhuaPanZhao2_close",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("left_ZhuaPanZhao2_close") == 0 then
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",21)
	        Stop()
	    elseif GetDI("left_ZhuaPanZhao2_close") == 1 then
	    	break
	    end
	end
...
function fun_BUNK_RIGHT_SHIFT()
    ...
    WaitDI("right_ZhuaPanZhao1_open",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("right_ZhuaPanZhao1_open") == 0 then
	        TPWrite("right_ZhuaPanZhao1_open Shi Bai")
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",22)
	        Stop()
	    elseif GetDI("right_ZhuaPanZhao1_open") == 1 then
	    	break
	    end 
	end

    WaitDI("right_ZhuaPanZhao2_open",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("right_ZhuaPanZhao2_open") == 0 then
	        TPWrite("right_ZhuaPanZhao2_open Shi Bai")
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",22)
	        Stop()
	    elseif GetDI("right_ZhuaPanZhao2_open") == 1 then
	    	break
	    end 
    end
    ...
    WaitDI("right_ZhuaPanZhao1_close",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("right_ZhuaPanZhao1_close") == 0 then
	        TPWrite("right_ZhuaPanZhao1_close Shi Bai")
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",23)
	        Stop()
	    elseif GetDI("right_ZhuaPanZhao1_close") == 1 then
	    	break
	    end   
    end

    WaitDI("right_ZhuaPanZhao2_close",1,6000,true)
    while(1) do
    	Sleep(200)
	    if GetDI("right_ZhuaPanZhao2_close") == 0 then
	        TPWrite("right_ZhuaPanZhao2_close Shi Bai")
	        SetDO("alarm_bee",1)
	     	SetDO("alarm_red",1)
	     	SetDO("alarm_green",0)
	        SetAO("Error_code",23)
	        Stop()
	    elseif GetDI("right_ZhuaPanZhao2_close") == 1 then
	    	break
	    end
    end
...
function fun_OUTER_TO_CENTER()
  ...
  WaitDI("qian_HengYi_gripper_open",1,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("qian_HengYi_gripper_open") == 0 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",30)
	    Stop()
	  elseif GetDI("qian_HengYi_gripper_open") == 1 then
	  	break
	  end
  end
...
function fun_OUTER_TO_LEFT()
  ...
  WaitDI("qian_HengYi_gripper_open",0,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("qian_HengYi_gripper_open") == 1 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",31)
	    Stop()
	  elseif GetDI("qian_HengYi_gripper_open") == 0 then
	  	break
	  end
  end
  local next = GetJointTarget("Xyzuvw")
...
function fun_INNER_TO_CENTER()
  ...
  WaitDI("hou_HengYi_gripper_open",1,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("hou_HengYi_gripper_open") == 0 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",31)
	    Stop()
	  elseif GetDI("hou_HengYi_gripper_open") == 1 then
	  	break
	  end
  end
...
function fun_INNER_TO_LEFT()
  ...
  WaitDI("hou_HengYi_gripper_open",0,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("hou_HengYi_gripper_open") == 1 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",31)
	    Stop()
	  elseif GetDI("hou_HengYi_gripper_open") == 0 then
	  	break
	  end
  end
...
function fun_BUNK_RIGHT_FULL_IN()
  ...
  WaitDI("right_qian_roller_reached",1)
  SetDO("right_feeder_qian_roller_in",0)
  --next.extax.eax_3 = K_R_5.extax.eax_1
  --MoveAbsJ(next,v_op40,fine,tool0,wobj0,load0)
end
...
function fun_OIL_LEFT()
  ...
  WaitDI("left_penyou_tuigan_opened",0,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("left_penyou_tuigan_opened") == 1 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",41)
	    Stop()
	  elseif GetDI("left_penyou_tuigan_opened") == 0 then
	  	break
	  end
  end

  WaitDI("left_penyou_tuigan_closed",1,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("left_penyou_tuigan_closed") == 0 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",41)
	    Stop()
	  elseif GetDI("left_penyou_tuigan_closed") == 1 then
	  	break
	  end
  end
  ...
  --打开喷油盒子
  SetDO("left_penyou_tuigan",1)
  WaitDI("left_penyou_tuigan_opened",1,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("left_penyou_tuigan_opened") == 0 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",40)
	    Stop()
	  elseif GetDI("left_penyou_tuigan_opened") == 1 then
	  	break
	  end
  end

  WaitDI("left_penyou_tuigan_closed",0,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("left_penyou_tuigan_closed") == 1 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",40)
	    Stop()
	  elseif GetDI("left_penyou_tuigan_closed") == 0 then
	  	break
	  end
  end
...
function fun_OIL_RIGHT()
  ...
  WaitDI("right_penyou_tuigan_opened",0,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("right_penyou_tuigan_opened") == 1 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",43)
	    Stop()
	  elseif GetDI("right_penyou_tuigan_opened") == 0 then
	  	break
	  end
  end
  WaitDI("right_penyou_tuigan_closed",1,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("right_penyou_tuigan_closed") == 0 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",43)
	    Stop()
	  elseif GetDI("right_penyou_tuigan_closed") == 1 then
	  	break
	  end
  end
  ...
  --打开喷油盒子
  SetDO("right_penyou_tuigan",1)
  WaitDI("right_penyou_tuigan_opened",1,6000,true)
  while(1) do
  	  Sleep(200)
	  if GetDI("right_penyou_tuigan_opened") == 0 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",42)
	    Stop()
	  elseif GetDI("right_penyou_tuigan_opened") == 1 then
	  	break
	  end
  end

  WaitDI("right_penyou_tuigan_closed",0,6000,true) 
  while(1) do
  	  Sleep(200)
	  if GetDI("right_penyou_tuigan_closed") == 1 then
	  	SetDO("alarm_bee",1)
	    SetDO("alarm_red",1)
	    SetDO("alarm_green",0)
	    SetAO("Error_code",42)
	    Stop()
	  elseif GetDI("right_penyou_tuigan_closed") == 0 then
	  	break
	  end
  end
...
function main2()
  while(1) do
    ...
    elseif GetAI("request")==Left_JinLiaoPan_count then 
      SetAO("response",Left_JinLiaoPan_count) 
      fun_Left_JinLiaoPan_count()
      SetAO("response",Left_JinLiaoPan_count+1)
    elseif GetAI("request")==Right_JinLiaoPan_count then 
      SetAO("response",Right_JinLiaoPan_count) 
      fun_Right_JinLiaoPan_count()
      SetAO("response",Right_JinLiaoPan_count+1)
...
ROBTARGET("P10",{960.000,154.391,-61.206},{0.999769,0.021498,0.000000,0.000000},{0,0,0,0},{583.597,238.598,353.597,468.598,0.000,0.000,0.000},0.000)
ROBTARGET("P20",{960.000,154.391,-61.206},{0.999769,0.021498,0.000000,0.000000},{0,0,0,0},{583.597,238.598,353.597,468.598,0.000,0.000,0.000},0.000)
ROBTARGET("P30",{960.000,154.391,-61.206},{0.999769,0.021498,0.000000,0.000000},{0,0,0,0},{583.597,238.598,353.597,468.598,0.000,0.000,0.000},0.000)
ROBTARGET("P40",{960.000,154.391,-61.206},{0.999769,0.021498,0.000000,0.000000},{0,0,0,0},{583.597,238.598,353.597,468.598,0.000,0.000,0.000},0.000)
STRINGDATA("received","")
STRINGDATA("send","")
end
print("The end!")